<!DOCTYPE html>
    ...
    <link rel="stylesheet" hreIf="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
    <!-- Font Awesome -->
    ...
    <footer class="main-footer">
        <strong>Copyright &copy;  siakad.com</strong>
        All rights reserved.
